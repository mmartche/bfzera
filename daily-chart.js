...
var dadosRaddaTotal = [
  ['02/12', 9844, 1129, 210, 2571, 0],
  ['05/12', 10712, 1130, 249, 3114, 0],
  ['06/12', 10882, 1130, 285, 3207, 0],
  ['07/12', 10882, 1130, 285, 3318, 0],
  ['08/12', 10882, 1130, 285, 3457, 0],
  ['09/12', 11162, 1356, 285,3485, 65],
  ['13/12', 12102, 1497, 358, 3853, 65],
  ['15/12', 12919, 1663, 358, 4077, 0],
  ['16/12', 12974, 1695, 441, 4157, 0],
  ['19/12', 13837, 1879, 441, 4835, 0],
  ['20/12', 13981, 1934, 441, 5033, 108],
  ['21/12', 14417, 1945, 441, 5322, 134],
  ['22/12', 14689, 2100, 441, 5795, 134],
  ['22/12', 14931, 2190, 441, 6048, 134]
];
raddasTotal.addRows(dadosRaddaTotal);
var dadosRaddaPerDay = [
  ['05/12', 868, 1,   39, 543],
  ['06/12', 170, 0,   36, 93],
  ['07/12', 0,   0,   0,  111],
  ['08/12', 0,   0,   0,  139],
  ['09/12', 280, 226, 0,  28],
  ['13/12', 940, 141, 73, 368],
  ['15/12', 817, 166, 0,  224],
  ['16/12', 55,  32,  83, 80],
  ['19/12', 863, 184, 0,  678],
  ['20/12', 144, 55,  0,  198],
...
raddasPerDay.addRows(dadosRaddaPerDay);
  var options = {
    ...
    colors: ['#a52714', 'yellow', 'blue', '#000000', 'green']
  };
